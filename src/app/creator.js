...
async function render() {
  ...
  for (const c of mine) {
    ...
    // Given to holders by choice at launch: generated by these coins, not kept.
  ...
  shell(`
    ...
    <div class="totals">
      ...
      <div class="tot"><span class="lab">Fees generated</span><span class="big">${money.show(money.round(kept) + money.round(holders) + money.round(dao))}</span></div>
      <div class="tot"><span class="lab">To this creator</span><span class="big">${money.show(kept)}</span></div>
      ${holders ? `<div class="tot"><span class="lab">To their holders</span><span class="big">${money.show(holders)}</span></div>` : ''}
    </div>
